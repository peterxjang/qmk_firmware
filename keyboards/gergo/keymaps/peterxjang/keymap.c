 ...
 * |        |   Q  |   W  |   E  |   R  |   T  |                         |   Y  |   U  |   I  |   O  |   P  |        |
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |        |Ctrl/A|   S  |   D  |   F  |   G  | Esc  |           | Spc  |   H  |   J  |   K  |   L  | ;/L2 |        |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * |        |Shft/Z|   X  |   C  |   V  |   B  | Bs   |           |      |   N  |   M  | ,  < | . >  |Shft/?|        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                       .-------.   .------.                                 .------.   .-------.
...
[BASE] = LAYOUT_gergo(
    ...
    KC_NO, LCTL_T(KC_A), KC_S, KC_D, KC_F, KC_G, KC_ESC,                        KC_SPC,  KC_H, KC_J, KC_K,    KC_L,   LT(MOVE, KC_SCLN), KC_NO,
    KC_NO, LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_BSPC, KC_VOLU,     KC_BRIU, KC_NO,   KC_N, KC_M, KC_COMM, KC_DOT, RSFT_T(KC_SLSH),   KC_NO,
