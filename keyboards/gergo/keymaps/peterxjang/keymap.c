...
[BASE] = LAYOUT_gergo(
    ...
    KC_NO, KC_A,         KC_S, KC_D, KC_F, KC_G, KC_NO,                   KC_NO, KC_H, KC_J, KC_K,    KC_L,   LT(MOVE, KC_QUOT), KC_NO,
    KC_NO, LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO,     KC_NO, KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, RSFT_T(KC_SLSH),   KC_NO,
       LOPT_T(KC_ESC), LCMD_T(KC_BSPC), LCTL_T(KC_TAB), KC_NO,     KC_NO, HYPR_T(KC_ENT), LT(SYMB, KC_SPC), KC_BSPC
    ),
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_F1,         KC_F2, KC_F3, KC_F4,  KC_F5,   KC_TRNS,                          KC_TRNS, KC_F6,  KC_MINS, KC_EQL,  KC_GRV,  KC_SCLN,         KC_TRNS,
    KC_TRNS, LSFT_T(KC_F7), KC_F8, KC_F9, KC_F10, KC_F11,  KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, KC_F12, KC_TRNS, KC_LBRC, KC_RBRC, RSFT_T(KC_BSLS), KC_TRNS,
